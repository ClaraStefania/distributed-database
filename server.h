...
/**
 * Functia elibereaza data dintr-o structura de tip request
 */
void
free_request_data(void *data);

/**
 * Functia aloca memorie pentru o structura de tip response
 */
response *
malloc_response();

/**
 * Functia aloca si initializeaza un server
 */
server *
